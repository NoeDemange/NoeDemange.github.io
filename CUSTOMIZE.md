...
To add publications create a new entry in the [\_bibliography/papers.bib](_bibliography/papers.bib) file. You can copy the BibTeX entry from the conference page, publisher page, arXiv, or any other source you prefer. By default, the publications will be sorted by year and the most recent will be displayed first. You can change this behavior and more in the `Jekyll Scholar` section in [_config.yml](_config.yml) file.
